...
//			e.setDynamicProperty(CellularComponentType.CELL_COMPONENT_KEY, ccType.toString());
			...
			FontProperty fontProperty = new FontProperty(color, "Arial", false, false, false, false, FONTSIZE, HALIGN,
					VALIGN);
			// borderColor, borderStyle, borderWidth, fillColor, shapeType, zOrder
			ShapeStyleProperty shapeStyleProperty = new ShapeStyleProperty(color, borderStyleType, borderWidth, Color.WHITE,
					type, Z_ORDER_LABEL);
...
//			gdata.setOrientation(OrientationType.RIGHT);
	...
	public static class ReactionTemplate extends InteractionTemplate {
		...
		public PathwayElement[] addElements(Pathway p, double mx, double my) {
			...
			Template lnt = new InteractionTemplate("line", LineStyle.SOLID, LineType.LINE, LineType.LINE,
					ConnectorType.STRAIGHT);
	...
	public static class ReversibleReactionTemplate extends InteractionTemplate {
		...
		public PathwayElement[] addElements(Pathway p, double mx, double my) {
			...
			Template rev = new InteractionTemplate("line", LineStyle.SOLID, LineType.LINE, LineType.LINE,
					ConnectorType.STRAIGHT);
			...
			Template lnt2 = new InteractionTemplate("line", LineStyle.SOLID, LineType.LINE, LineType.LINE,
					ConnectorType.STRAIGHT);
