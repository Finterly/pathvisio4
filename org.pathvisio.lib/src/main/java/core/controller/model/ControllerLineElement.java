 ...
 * VPathway.
 */
public abstract class ControllerLineElement extends Graphics {
	...
	public ControllerLineElement(VPathwayModel canvas, LineElement o) {
		super(canvas);
		o.addListener(this);
		gdata = o;
		checkCitation();
	...
	public ControllerLineElement(VPathwayModel canvas) {
		super(canvas);
		o.addListener(this);
		gdata = o;
		checkCitation();
...
//		if(parent != null) parent.remove(gdata);
	...
	protected int getZOrder() {
		return gdata.getLineStyleProperty().getZOrder();
	}

	protected Color getLineColor() {
		Color linecolor = gdata.getLineStyleProperty().getLineColor();
		/*
	...
	protected void setLineStyle(Graphics2D g) {
		LineStyleType ls = gdata.getLineStyleProperty().getLineStyle();
		float lt = (float) vFromM(gdata.getLineStyleProperty().getLineWidth());
