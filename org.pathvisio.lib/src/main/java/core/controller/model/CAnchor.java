 ...
 */
public class CAnchor extends VElement implements LinkProvider, Adjustable {
	 ...
	 */
	public CAnchor(Anchor mAnchor, CLine parent) {
	...
	protected void doDraw(Graphics2D g) {
		if (getMAnchor().getShapeType().equals(AnchorShapeType.NONE) && getMAnchor().getGraphId() != null) {
			return;
		}
		Color c;
