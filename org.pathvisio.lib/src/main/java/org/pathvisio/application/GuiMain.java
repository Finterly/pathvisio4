...
import org.pathvisio.application.exporter.BatikImageWithDataExporter;
import org.pathvisio.application.exporter.DataNodeListExporter;
import org.pathvisio.application.exporter.EUGeneExporter;
import org.pathvisio.application.exporter.ImageExporter;
import org.pathvisio.application.exporter.RasterImageWithDataExporter;
...
import org.pathvisio.core.modeltemp.MappFormat;
...
//		pvDesktop.initPlugins();
	...
	public void gexManagerEvent(GexManagerEvent e) {
		if (e.getType() == GexManagerEvent.CONNECTION_OPENED || e.getType() == GexManagerEvent.CONNECTION_CLOSED) {
