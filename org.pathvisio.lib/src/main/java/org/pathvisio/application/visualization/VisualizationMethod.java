...
/**
 * The VisualizationMethod class can be extended to create a visualization
 * method for the visualization of experimental data on GPML pathways
 */
public interface VisualizationMethod extends Comparable<VisualizationMethod> {
	 ...
	 */
	public void visualizeOnDrawing(VPathwayObject g, Graphics2D g2d);
...
//	public abstract Composite visualizeOnToolTip(Composite parent, Graphics g);
	...
	public Component visualizeOnToolTip(VPathwayObject g);

	/**
	 * Return a default drawing order for this visualization method. The user may
	 * override this default, but a sensible default can be provided.
	 *
	 * Opaque drawing methods should return a value of 0 or less Transparant drawing
	 * methods (e.g. labels) should return a value of 1 or higher.
	 */
	public int defaultDrawingOrder();

	/**
	 * Save the configuration of the current instance of this class to an XML
	 * element.<br>
	...
	/**
	 * Load the configuration of the current instance of this class from an XML
	 * element.<br>
	 ...
	 * </code>
	 * 
	 * @param xml The {@link Element} that contains the configuration for this
	 *            plugin
	 */
	...
	/**
	 * Returns whether this visualization plugin uses the area provided by the
	 * {@link Visualization} it belongs to.
	 * 
	...
	/**
	 * Signals that the visualization has become active or inactive. Individual
	 * VisualizationMethods can respond by doing global preparation work.
	 */
