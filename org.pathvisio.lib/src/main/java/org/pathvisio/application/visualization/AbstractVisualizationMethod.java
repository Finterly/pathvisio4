...
public abstract class AbstractVisualizationMethod implements VisualizationMethod
{
	 ...
	 * graphics.
	 * When multiple visualization plugins apply visualizations on the same {@link Controller}
	 * object, the available space will be divided over the plugins for which this method is called
	 * with true as argument.
	 * The provided area can be obtained by calling {@link Visualization#provideDrawArea(AbstractVisualizationMethod, Controller)}
	 * @param use	true if this plugin uses the provided area, false if not
	 * @see Visualization#provideDrawArea(AbstractVisualizationMethod, Controller)
	 */
