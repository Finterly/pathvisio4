...
public class PathwayTransferable implements Transferable {
	 ...
	 * @throws IOException
	 */
	public static PathwayModel pathwayFromTransferable(Transferable t) throws ConverterException, MalformedURLException, UnsupportedFlavorException, IOException {
		PathwayModel pnew = new PathwayModel();
