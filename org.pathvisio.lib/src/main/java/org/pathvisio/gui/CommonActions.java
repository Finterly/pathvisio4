...
//					new LayoutAction(e, LayoutType.STACK_BOTTOM)
		...
		newElementActions = new Action[][] {
				...
				new Action[] { new NewElementAction(e, new DefaultTemplates.LabelTemplate()) }, new Action[] {
						// TODO is ARROW DIRECTED?
				...
				// },
				new Action[] { new NewElementAction(e, new DefaultTemplates.InteractionTemplate("tbar", LineStyleType.SOLID,
...
//									"ligandround", LineStyleType.SOLID, ArrowHeadType.UNDIRECTED, LineType.LIGAND_ROUND, ConnectorType.STRAIGHT)
//							),
//							new NewElementAction(e, new DefaultTemplates.LineTemplate(
//									"receptorround", LineStyleType.SOLID, ArrowHeadType.UNDIRECTED, LineType.RECEPTOR_ROUND, ConnectorType.STRAIGHT)
//							),
//							new NewElementAction(e, new DefaultTemplates.LineTemplate(
//									"ligandsquare", LineStyleType.SOLID, ArrowHeadType.UNDIRECTED, LineType.LIGAND_SQUARE, ConnectorType.STRAIGHT)
//							),
//							new NewElementAction(e, new DefaultTemplates.LineTemplate(
...
//				 new NewElementAction(e, new DefaultTemplates.ShapeTemplate(ShapeType.EDGE)),
		...
		newMIMInteractionActions = new Action[] {
				 ...
				 * DefaultTemplates.LineTemplate( "Branching left", LineStyleType.SOLID,
				 * ArrowHeadType.UNDIRECTED, MIMShapes.MIM_BRANCHING_LEFT, ConnectorType.STRAIGHT) ), new
				 * NewElementAction(e, new DefaultTemplates.LineTemplate( "Branching right",
				 * LineStyleType.SOLID, ArrowHeadType.UNDIRECTED, MIMShapes.MIM_BRANCHING_RIGHT,
				 * ConnectorType.STRAIGHT) ),
				 */ new NewElementAction(e,
	...
	public static class ZoomAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			VPathwayModel vPathwayModel = engine.getActiveVPathway();
			if (vPathwayModel != null) {
				vPathwayModel.centeredZoom(zoomFactor);
			}
		}
