...
public abstract class VElement implements Comparable<VElement> {
	...
	/**
	 * Marks both the area currently and previously occupied by this object for
	...
	/**
	 * Returns the cached rectangular bounds of this object This method is
	 * equivalent to {@link #getVOutline()}.getBounds2D()
	 * 
	 * @return vBoundsCache
	 */
	...
	/**
	 * Returns the cached outline of this element. The outline is used to check
	 * whether a point is contained in this element or not and includes the stroke
	 * and takes into account rotation. Because it includes the stroke, it is not a
	 * direct model to view mapping of the model outline!
	 * 
	 * @return vOutlineCache the outline of this element
	 */
