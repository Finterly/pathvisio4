...
public class GroupPainterRegistry {
	 ...
	 * 
	 * @param name    The name of the group style (use
	 *                {@link GroupStyle#toString()}.
	...
	static {
		...
		registerPainter(GroupType.GROUP.toString(), defaultPainter); // TODO looks better?
		registerPainter(GroupType.GROUP.toString(), groupPainter); // more invisible...
